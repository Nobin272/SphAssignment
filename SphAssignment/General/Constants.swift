...
struct Constants {
    struct SPHFont {
        ...
        static let fontRegular14            = UIFont.monospacedDigitSystemFont(ofSize: 14, weight: .regular)
        ...
        static let fontMedium16             = UIFont.monospacedDigitSystemFont(ofSize: 16, weight: .medium)
        ...
        static let fontBold11               = UIFont.monospacedDigitSystemFont(ofSize: 10.5, weight: .bold)
        ...
        static let fontBold35               = UIFont.monospacedDigitSystemFont(ofSize: 37.5, weight: .bold)
